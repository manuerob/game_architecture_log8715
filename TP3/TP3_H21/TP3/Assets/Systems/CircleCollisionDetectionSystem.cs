...
public class CircleCollisionDetectionSystem : IExtrapolatableSystem
{
    public string Name
    {
        get
    ...
    {
        ComponentsManager.Instance.ForEach<ShapeComponent, ReplicationMessage>((entity1, shapeComponent1, replicationMessage) =>
        {
