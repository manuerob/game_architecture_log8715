...
public class WallCollisionDetectionSystem : IExtrapolatableSystem
{
    public string Name
    {
        get
    ...
    {
        ComponentsManager.Instance.ForEach<ShapeComponent, ReplicationMessage>((entity, shapeComponent, replicationMessage) =>
        {
            Vector2 speed = shapeComponent.speed;
            Vector2 screenBorderPos = Camera.main.ScreenToWorldPoint(new Vector2(Screen.width, Screen.height));
